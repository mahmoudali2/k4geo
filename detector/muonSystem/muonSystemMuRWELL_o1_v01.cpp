...
//  int sensitiveLayerIndex = 0;
  ...
  double shapeAngle = 360.0 / numSides; // it's the half angle
  ...
  double sideEnvY = (sideLength / 2.0) + clearance/2.0;
...
// ----------------------------------------------------------------------------------------------------
  ...
  double barrelLayerRMax = radius + detectorVolumeThickness/2.0;

  dd4hep::PolyhedraRegular  BarrelDetectorLayer(numSides, barrelLayerRMin, barrelLayerRMax, barrelLength);
  dd4hep::Volume BarrelDetectorLayerVolume("barrel_DetectorLayer" + numBarrelLayer , BarrelDetectorLayer, mat);
  ...
  //    dd4hep::Trapezoid sideEnvelope(barrelLength/2.0, barrelLength/2.0, sideTRDLength1/2.0, sideTRDLength2/2.0, detectorVolumeThickness/2.0);      
      ...
      dd4hep::RotationZ sideRotationZ(angle_radians+shapeAngle_radians);
  //    dd4hep::RotationY sideRotationY(90.* dd4hep::degree);     
      ...
      dd4hep::PlacedVolume sidePhys = BarrelDetectorLayerVolume.placeVolume(sideVol, dd4hep::Transform3D(sideRotation, sideTrans));
...
// -------------------------------------------------------------------------------------------------------      
      ...
      for (int copyIndexZ = 0; copyIndexZ < numCopiesZ; ++copyIndexZ) {
        ...
        double yRotation = std::atan(dimensions.x() / (dimensions.z() - (2 * overlapZ)));
...
/*
        double remainderYRotation = std::atan(dimensions.x() / (remainderZ * dimensions.z() - (2 * overlapZ)));
        double remainderZRotation = std::atan(dimensions.x() / (remainderY * dimensions.y() - (2 * overlapY)));
        dd4hep::RotationY remainderRotationY(remainderYRotation);
        dd4hep::RotationZ remainderRotationZ(remainderZRotation);
        // Combine the Y and Z rotations to get a 3D rotation
        dd4hep::Rotation3D YremainderRotation = remainderRotationY * rotationZ;        
        dd4hep::Rotation3D ZremainderRotation = rotationY * remainderRotationZ; 
        dd4hep::Rotation3D YZremainderRotation = remainderRotationY * remainderRotationZ; 
*/
        ...
        nameStream2 << "MuRWELL_Barrel_" << nameCounter++;
        std::string chamberName2 = nameStream2.str();
...
// --------------------------------------------------------------------------------------------
        ...
        if (copyIndexY == (numCopiesY - 1) || copyIndexZ == (numCopiesZ - 1)) {
            ...
            if (copyIndexY == (numCopiesY - 1) && copyIndexZ != (numCopiesZ - 1)) {            
              ...
              dd4hep::Volume remainderYEnvVolume(chamberName2 + "remainderY", remainderYEnvelope, lcdd.material(dimensions.materialStr()));
              ...
              dd4hep::DetElement envDE(sideDE, chamberName2, chamberID);
              ...
              for (unsigned layerIdx = 0; layerIdx < numLayers; ++layerIdx) {
                ...
                dd4hep::PlacedVolume layerPlacedVolume = remainderYEnvVolume.placeVolume(layerVolume, dd4hep::Transform3D(dd4hep::RotationZ(0.), transLayer));
              ...
              //  layerDE.setPlacement(layerPlacedVolume);
                ...
                // dd4hep::printout(dd4hep::INFO,"Sensitive layer has been created at", name, chamberName2);
                  sensitiveLayerIndex++;
                }
...
// -----------------------------------------------
            ...
            if (copyIndexZ == (numCopiesZ - 1) && copyIndexY != (numCopiesY - 1)) {
              ...
              dd4hep::Volume remainderZEnvVolume(chamberName2 + "remainderZ", remainderZEnvelope, lcdd.material(dimensions.materialStr()));
              ...
              for (unsigned layerIdx = 0; layerIdx < numLayers; ++layerIdx) {
                ...
                dd4hep::Volume layerVolume(layerName, layerShape, lcdd.material(layer.attr<std::string>("material")));
                dd4hep::Position transLayer(layerDet.x_offset(), layerDet.y_offset(), layerDet.z_offset());
                dd4hep::PlacedVolume layerPlacedVolume = remainderZEnvVolume.placeVolume(layerVolume, dd4hep::Transform3D(dd4hep::RotationZ(0.), transLayer));
              //  dd4hep::DetElement layerDE(envDE, "layerDE", layerIdx);
              //  layerDE.setPlacement(layerPlacedVolume);
...
// ------------------------------------------------------------
            ...
            if (copyIndexY == (numCopiesY - 1) && copyIndexZ == (numCopiesZ - 1)) {            
              ...
              dd4hep::Volume remainderYZEnvVolume(chamberName2 + "remainderYZ", remainderYZEnvelope, lcdd.material(dimensions.materialStr()));
              ...
              for (unsigned layerIdx = 0; layerIdx < numLayers; ++layerIdx) {
                ...
                dd4hep::Volume layerVolume(layerName, layerShape, lcdd.material(layer.attr<std::string>("material")));
                dd4hep::Position transLayer(layerDet.x_offset(), layerDet.y_offset(), layerDet.z_offset());
                dd4hep::PlacedVolume layerPlacedVolume = remainderYZEnvVolume.placeVolume(layerVolume, dd4hep::Transform3D(dd4hep::RotationZ(0.), transLayer));
              //  dd4hep::DetElement layerDE(envDE, "layerDE", layerIdx);
              //  layerDE.setPlacement(layerPlacedVolume);
...
// -------------------------------------------------------------
        ...
        dd4hep::Volume envVolume(chamberName2, envelope, lcdd.material(dimensions.materialStr()));
  ...
  dd4hep::DetElement BarrelDetectorLayerDE(detElement, "barrel_DetectorLayerDE", numBarrelLayer);
...
// ---------------------------------------// B A R R E L // R A D I A T O R S //------------------------------------------------
  ...
  if ( numBarrelRadiators > 0) {
    ...
    dd4hep::Volume BarrelRadiatorLayerVolume("barrel_RadiatorLayer" + numBarrelRadiatorLayer , BarrelRadiatorLayer, mat);
...
//---------------------------------------Detectors--------------------------------------------
  ...
  if ( numEndcapDetectorLayers > 0) {
    ...
    dd4hep::PlacedVolume endcapDetectorEnvelopePhys = detectorVolume.placeVolume(endcapDetectorEnvVol, dd4hep::Transform3D(dd4hep::RotationZ(shapeAngle_radians), endcapDetectorEnvelopeTrans));
...
//        endcapDetectorSideEnvPhys.addPhysVolID("endcapDetectorSideEnvelope", side);
        ...
        for (int rectangle = 0; rectangle < numChambersY; ++rectangle) {
          ...
          double rectangleEnvY = (endcapDetectorLayerOuterRadius - rectangle * (2 * dimensions.y() - overlapY)) * std::tan(shapeAngle_radians) + clearance; // without multiplying by 2 .. because it is the half length // it should be dimensions.x() instead of z, but in the endcap its perpendicular to usual dimension set
          ...
          double yRotation = std::atan(dimensions.x() / (dimensions.y() - (2 * overlapY)));
          dd4hep::RotationY rotationY(yRotation);
 ...
 //         rectangleEnvelopePhys.addPhysVolID("rectangleEnvelope", rectangle);
          ...
          endcapNameStream << "MuRWELL_Endcap_" << endcapChamberID++;
...
// -----------------------------------------------------------------------------
 ...
 //       endcapDetectorSideEnvPhys.addPhysVolID("endcapDetectorSideEnvelope", side);
        ...
        for (int rectangle = 0; rectangle < numChambersY; ++rectangle) {
          ...
          double rectangleEnvX = endcapDetectorEnvZ/4.0;
          double rectangleEnvY = (endcapDetectorLayerOuterRadius - rectangle * (2 * dimensions.z() - overlapY)) * std::tan(shapeAngle_radians) + clearance/2.0; // without multiplying by 2 .. because it is the half length // it should be dimensions.x() instead of z, but in the endcap its perpendicular to usual dimension set
          double rectangleEnvZ = dimensions.y() + clearance/2.0;
...
//          rectangleEnvelopePhys.addPhysVolID("rectangleEnvelope", rectangle);
          ...
          dd4hep::Box envelope(dimensions.x(), dimensions.y(), dimensions.z());
          dd4hep::Volume envVolume(EndcapChamberName, envelope, lcdd.material(dimensions.materialStr())); // "name" has to be changed
...
// --------------------------------------Radiators--------------------------------------------
  if ( numEndcapRadiators > 0) {
    ...
    dd4hep::PlacedVolume endcapRadiatorEnvelopePhys = detectorVolume.placeVolume(endcapRadiatorEnvVol, dd4hep::Transform3D(dd4hep::RotationZ(shapeAngle_radians), endcapRadiatorEnvelopeTrans));
